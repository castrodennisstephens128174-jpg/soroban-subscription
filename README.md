# Soroban Subscription

> A **soroban-subscription** dApp — Soroban smart contract on Stellar testnet with a Next.js UI, a Freighter wallet adapter, and a real testnet transaction recorded in `docs/submission-proof.json`. An independent Stellar-ecosystem demo dApp.
...
- [x] **Public GitHub repository** — github.com/d23930249/soroban-subscription
